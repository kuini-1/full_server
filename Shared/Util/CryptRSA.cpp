...
int CCryptRSA::Encrypt(unsigned char *originalData, int originalDataLength, unsigned char *encData, int encDataSize)
{	
...
// decryption function
//128 bytes block
int CCryptRSA::Decrypt(unsigned char *originalData, int originalDataLength, unsigned char *decData, int decDataSize)
{	
