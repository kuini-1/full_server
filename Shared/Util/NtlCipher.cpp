...
#include <wchar.h>
#include "../../Server/NtlSystem/NtlBase.h"
...
int CNtlCipher::Encrypt(const char* originalData, int originalDataLength, char* encData,int encDataSize)
{
	int retLength =0 ;
...
int CNtlCipher::Decrypt(const char* originalData, int originalDataLength, char* decData,int decDataSize)
{	
	int retLength =0 ;
