...
class CLogMessageManager
{
	...
	public:
		...
		bool						Create( TCHAR * lptFilePath = (TCHAR *)NULL, WORD wFilter = LMM_FILTER_DEFAULT, bool bUseMessageQueue = false );
		bool						Destroy( void );
		...
		bool						SetLastLogMessage( const TCHAR * const lptLogMessage, WORD wFilter = LMM_PRIORITY_DEFAULT, bool bWriteToFile = true );
	...
	public:
		...
		static void					GlobalLog( const TCHAR * const lptLogMessage );
		...
		static void					GlobalError( const TCHAR * const lptErrorMessage );
...
//////////////////////////////////////////////////////////////////////////////
//
// End of File : LogMessageManager.h
//
//////////////////////////////////////////////////////////////////////////////