...

		{
			...
			for ( ; itAgent != m_defAgentList.end(); ++itAgent )
			{
...

				{
					...
					NTL_SNPRINTF( szTempBuffer, 128, "%d_%d.%s", 0, (tSigned32)WORLD_COORD_TO_PATH_COORD(sAgent.fRadius), PE_FIELD_GROUP_COL_PRE_EXT );
...

				{
					...
					NTL_SNPRINTF( szTempBuffer, 128, "%d_%d.%s", 0, (tSigned32)WORLD_COORD_TO_PATH_COORD(sAgent.fRadius), PE_FIELD_GROUP_PATH_FIND_PRE_EXT );
