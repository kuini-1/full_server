...
public:
    ...
    virtual ~iCollisionInfo() = default; // Virtual destructor to ensure proper cleanup in derived classes.

    virtual void destroy() = 0; // Abstract destroy method
    virtual void getCollidingLine(tSigned32* coords) const = 0; // Abstract method for getting colliding line
    virtual iAgent* getCollidingAgent() const = 0;
};
