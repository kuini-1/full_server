...
void CMasterServerSession::RecvGameServerChannelUpdated(CNtlPacket * pPacket)
{
	...
	//	printf("pChannel->dwLoad %u pChannel->dwMaxLoad %u \n", pChannel->dwLoad, pChannel->dwMaxLoad);
		...
		/*
		res->serverChannelInfo.sChannelBuff.byBonusMoveSpeed = 10;
		res->serverChannelInfo.sChannelBuff.byBonusStat = 10;
		res->serverChannelInfo.sChannelBuff.byBonusVehicleMoveSpeed = 10;
		res->serverChannelInfo.sChannelBuff.byMaxLevel = 100;
		res->serverChannelInfo.sChannelBuff.byMinLevel = 1;
		res->serverChannelInfo.sChannelBuff.byRaceBitFlag = 1;
		*/
