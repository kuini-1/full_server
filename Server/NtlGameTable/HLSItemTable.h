...
const DWORD		DBO_MAX_LENGTH_HLSITEM_ID_TEXT = 140;
...
public:
	...
	WCHAR			szIcon_Name[DBO_MAX_LENGTH_HLSITEM_ICON_NAME + 1];
...
protected:
	WCHAR** GetSheetListInWChar() { return const_cast<WCHAR**>(&(CHLSItemTable::m_pwszSheetList[0])); }
