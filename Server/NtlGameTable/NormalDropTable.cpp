...
const WCHAR* CNormalDropTable::m_pwszSheetList[] =
{
	L"Table_Data_KOR",
	NULL
};
...
bool CNormalDropTable::AddTable(void * pvTable, bool bReload, bool bUpdate)
{
...
bool CNormalDropTable::LoadFromBinary(CNtlSerializer& serializer, bool bReload, bool bUpdate)
{
