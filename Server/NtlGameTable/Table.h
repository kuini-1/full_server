...
public:
	enum eLOADING_METHOD
	{
		...
		LOADING_METHOD_INVALID = (unsigned char)0xFF
	};
...
#if !defined(_WIN32)
	void						CheckNegativeInvalid(const WCHAR* pwszFormatString, BSTR bstr); // Linux: WCHAR* overload (WCHAR is unsigned short, distinct from wchar_t).
#endif
