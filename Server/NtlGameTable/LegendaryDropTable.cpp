...
bool CLegendaryDropTable::AddTable(void * pvTable, bool bReload, bool bUpdate)
{
...
bool CLegendaryDropTable::LoadFromBinary(CNtlSerializer& serializer, bool bReload, bool bUpdate)
{
	if( false == bReload )
	{
		Reset();
