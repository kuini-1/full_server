...
void CDboTSColRgn::TakeScriptDataForScript( CNtlTSScrProperty& clProperty )
{
	...
	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_uiWorldTblIdx );
	clProperty.m_defProperty["widx"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_uiColCheckType );
	clProperty.m_defProperty["cct"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_eColRgnType );
	...
	case eEVENT_COL_RGN_TYPE_RADIUS:
		{
			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRadius.x );
			clProperty.m_defProperty["x"] = g_NtlTSString;

			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRadius.z );
			clProperty.m_defProperty["z"] = g_NtlTSString;

			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRadius.r );
	...
	case eEVENT_COL_RGN_TYPE_RECTANGLE:
		{
			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRectangle.x[0] );
			clProperty.m_defProperty["x0"] = g_NtlTSString;

			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRectangle.z[0] );
			clProperty.m_defProperty["z0"] = g_NtlTSString;

			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRectangle.x[1] );
			clProperty.m_defProperty["x1"] = g_NtlTSString;

			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRectangle.z[1] );
			clProperty.m_defProperty["z1"] = g_NtlTSString;

			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRectangle.x[2] );
			clProperty.m_defProperty["x2"] = g_NtlTSString;

			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRectangle.z[2] );
			clProperty.m_defProperty["z2"] = g_NtlTSString;

			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRectangle.x[3] );
			clProperty.m_defProperty["x3"] = g_NtlTSString;

			NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_uColRngData.sRectangle.z[3] );
