...
void CDboTSActEscort::TakeScriptDataForScript( CNtlTSScrProperty& clProperty )
{
	...
	snprintf(g_NtlTSString, sizeof(g_NtlTSString), "%d", IsEscortStart() ? 1 : 0);
	clProperty.m_defProperty["start"] = g_NtlTSString;

	snprintf(g_NtlTSString, sizeof(g_NtlTSString), "%d", GetEscortType());
	clProperty.m_defProperty["etype"] = g_NtlTSString;

	snprintf(g_NtlTSString, sizeof(g_NtlTSString), "%d", IsTSShare() ? 1 : 0);
	clProperty.m_defProperty["tsshare"] = g_NtlTSString;

	snprintf(g_NtlTSString, sizeof(g_NtlTSString), "%d", GetNPCTableIndex());
