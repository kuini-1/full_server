...
void CDboTSActRegQInfo::ApplyScriptDataForScript( const CNtlTSScrProperty& clProperty )
{
	...
	{
		// ��ũ��Ʈ���� eQUEST_SORT_TYPE Ÿ�Ե��� Bit flag�� ���յǾ� ����ǹǷ�
		// �и��ؼ� �о�鿩�� �Ѵ�.
		// ���� eQUEST_SORT_TYPE �� �������� �ʴ� ���� 0 �̴�
...
void CDboTSActRegQInfo::TakeScriptDataForScript( CNtlTSScrProperty& clProperty )
{
	...
	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetTitle() );
	clProperty.m_defProperty["title"]		= g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetArea() );
	clProperty.m_defProperty["area"]		= g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetGoal() );
	clProperty.m_defProperty["goal"]		= g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetGrade() );
	clProperty.m_defProperty["grade"]		= g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetGradeType() );
	...
	{
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", 0 );
		clProperty.m_defProperty["stype"]	= g_NtlTSString;
	}
	else
	{
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", (1<<GetSortType()) );
		clProperty.m_defProperty["stype"]	= g_NtlTSString;
	}

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetSort() );
	clProperty.m_defProperty["sort"]		= g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetContents() );
	clProperty.m_defProperty["cont"]		= g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetReward() );
	clProperty.m_defProperty["rwd"]			= g_NtlTSString;

	if ( 0xffffffff != m_sQuestMarkInfo[0].uiWorldTblIdx )
	{
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_sQuestMarkInfo[0].uiWorldTblIdx );
		clProperty.m_defProperty["m0widx"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[0].fX );
		clProperty.m_defProperty["m0fx"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[0].fY );
		clProperty.m_defProperty["m0fy"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[0].fZ );
		clProperty.m_defProperty["m0fz"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_sQuestMarkInfo[0].uiTooltipIdx );
		clProperty.m_defProperty["m0ttip"]	= g_NtlTSString;
	}

	if ( 0xffffffff != m_sQuestMarkInfo[1].uiWorldTblIdx )
	{
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_sQuestMarkInfo[1].uiWorldTblIdx );
		clProperty.m_defProperty["m1widx"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[1].fX );
		clProperty.m_defProperty["m1fx"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[1].fY );
		clProperty.m_defProperty["m1fy"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[1].fZ );
		clProperty.m_defProperty["m1fz"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_sQuestMarkInfo[1].uiTooltipIdx );
		clProperty.m_defProperty["m1ttip"]	= g_NtlTSString;
	}

	if ( 0xffffffff != m_sQuestMarkInfo[2].uiWorldTblIdx )
	{
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_sQuestMarkInfo[2].uiWorldTblIdx );
		clProperty.m_defProperty["m2widx"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[2].fX );
		clProperty.m_defProperty["m2fx"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[2].fY );
		clProperty.m_defProperty["m2fy"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[2].fZ );
		clProperty.m_defProperty["m2fz"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_sQuestMarkInfo[2].uiTooltipIdx );
		clProperty.m_defProperty["m2ttip"]	= g_NtlTSString;
	}

	if ( 0xffffffff != m_sQuestMarkInfo[3].uiWorldTblIdx )
	{
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_sQuestMarkInfo[3].uiWorldTblIdx );
		clProperty.m_defProperty["m3widx"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[3].fX );
		clProperty.m_defProperty["m3fx"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[3].fY );
		clProperty.m_defProperty["m3fy"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[3].fZ );
		clProperty.m_defProperty["m3fz"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_sQuestMarkInfo[3].uiTooltipIdx );
		clProperty.m_defProperty["m3ttip"]	= g_NtlTSString;
	}

	if ( 0xffffffff != m_sQuestMarkInfo[4].uiWorldTblIdx )
	{
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_sQuestMarkInfo[4].uiWorldTblIdx );
		clProperty.m_defProperty["m4widx"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[4].fX );
		clProperty.m_defProperty["m4fx"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[4].fY );
		clProperty.m_defProperty["m4fy"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", m_sQuestMarkInfo[4].fZ );
		clProperty.m_defProperty["m4fz"]	= g_NtlTSString;

		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", m_sQuestMarkInfo[4].uiTooltipIdx );
		clProperty.m_defProperty["m4ttip"]	= g_NtlTSString;
	}

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetM0Pat() );
	clProperty.m_defProperty["m0pat"]			= g_NtlTSString;
	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetM1Pat() );
	clProperty.m_defProperty["m1pat"]			= g_NtlTSString;
	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetM2Pat() );
	clProperty.m_defProperty["m2pat"]			= g_NtlTSString;
	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetM3Pat() );
	clProperty.m_defProperty["m3pat"]			= g_NtlTSString;
	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetM4Pat() );
	clProperty.m_defProperty["m4pat"]			= g_NtlTSString;
	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetScItem() );
