...
//new
#define DBO_EVENT_TYPE_ID_CLICK_SIDEICON		(NTL_TSENTITY_TYPE_EVENT_NEXT+24)
#define DBO_EVENT_TYPE_ID_DIALOGOPEN			(NTL_TSENTITY_TYPE_EVENT_NEXT+25)
#define DBO_EVENT_TYPE_ID_QUEST					(NTL_TSENTITY_TYPE_EVENT_NEXT+26)
#define DBO_EVENT_TYPE_ID_LEVELCHECK			(NTL_TSENTITY_TYPE_EVENT_NEXT+27)
