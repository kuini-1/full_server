...
void CDboTSContUsrSel::ApplyScriptDataForScript( const CNtlTSScrProperty& clProperty )
{
	...
	{
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", i ); strConcId = strId + g_NtlTSString;
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", i ); strConcDesc = strDesc + g_NtlTSString;
...
void CDboTSContUsrSel::TakeScriptDataForScript( CNtlTSScrProperty& clProperty )
{
	...
	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", (int)GetUserSelType() );
	clProperty.m_defProperty["ust"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", (int)GetUserSelProgState() );
	clProperty.m_defProperty["uspt"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", (int)GetTargetType() );
	clProperty.m_defProperty["type"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetTargetTblIdx() );
	...
	for ( int i = 0; cit != m_defNextLink.end(); ++i, ++cit )
	{
		...
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", i ); strConcDesc = strDesc + g_NtlTSString;
		NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", cit->second );
