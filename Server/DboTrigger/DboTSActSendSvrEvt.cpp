...
void CDboTSActSendSvrEvt::TakeScriptDataForScript( CNtlTSScrProperty& clProperty )
{
	...
	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetSvrEvtType() );
	clProperty.m_defProperty["type"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetSvrEvtTriggerType() );
	clProperty.m_defProperty["ttype"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetSvrEvtID() );
	clProperty.m_defProperty["id"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetTblIdx() );
	clProperty.m_defProperty["tblidx"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetEvtSendType() );
	clProperty.m_defProperty["stype"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%f", GetEvtSendType_Radius() );
