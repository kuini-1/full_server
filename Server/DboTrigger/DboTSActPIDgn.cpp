...
void CDboTSActPIDgn::TakeScriptDataForScript( CNtlTSScrProperty& clProperty )
{
	...
	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetDungeonType() );
	clProperty.m_defProperty["type"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetNormalDungeonTblIdx() );
	clProperty.m_defProperty["nidx"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetHardDungeonTblIdx() );
	clProperty.m_defProperty["hidx"] = g_NtlTSString;

	NTL_SNPRINTF( g_NtlTSString, sizeof(g_NtlTSString), "%d", GetRDungeonTblIdx() );
