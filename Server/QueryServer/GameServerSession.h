...
public:
	...
	void						RecvGiftShopItemBuyReq(CNtlPacket* pPacket, CQueryServer* app);
	...
	void						RecvCanLoadCache(CNtlPacket* pPacket, CQueryServer* app); // by kuini can load cache
	void						RecvClassChange(CNtlPacket* pPacket, CQueryServer* app); // by kuini set class change
};