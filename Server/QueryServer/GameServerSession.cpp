...
int CGameServerSession::OnDispatch(CNtlPacket * pPacket)
{
	...
	switch (pHeader->wOpCode)
	{
		...
		case GQ_GIFT_SHOP_BUY_REQ: RecvGiftShopItemBuyReq(pPacket, app); break;
		...
		case GQ_CAN_LOAD_CACHE: RecvCanLoadCache(pPacket, app); break; // by kuini can load cache
		case GQ_CLASS_CHANGE: RecvClassChange(pPacket, app); break; // by kuini can load cache
