...
public:
	...
	void					Broadcast(CNtlPacket* pPacket, CSpawnObject* except = NULL); //send to others with exception
	...
	bool					SetCurLoc(sVECTOR3& loc, CWorld *pDestWorld = NULL);
	bool					SetCurLoc(CNtlVector& loc, CWorld *pDestWorld = NULL);
