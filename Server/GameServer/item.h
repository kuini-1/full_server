...
public:
	...
	inline sITEM_TBLDAT*		GetTbldat()	{ return &m_pProto; }
	...
	void						GenerateOptionSet(BYTE upgradeAmount);
	...
	static bool					ChangeOption(WORD wOptionIndex, sITEM_TBLDAT* pTbldat, sITEM_DATA* pItemData, BYTE byRank, sITEM_OPTION_SET* sOptionSet, TBLIDX kit, BYTE isGM = 0);
