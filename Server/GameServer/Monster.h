...
public:
	...
	virtual void		RandomMobDrop(int prob, TBLIDX item, BYTE amount, CCharacterObject* mob, CPlayer* player, BYTE type);

public:

	sMOB_TBLDAT*		GetTbldat() { return (sMOB_TBLDAT*)m_pTbldat; }
