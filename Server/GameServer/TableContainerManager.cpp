...
//	fileNameList.SetFileName(CTableContainer::TABLE_ITEM_UPGRADE,			"Table_Item_Upgrade_Data");
	...
	flagManager.Set(CTableContainer::TABLE_HLS_MERCHANT);
	fileNameList.SetFileName(CTableContainer::TABLE_HLS_MERCHANT,			"table_hls_merchant_data");
...
//	fileNameList.SetFileName(CTableContainer::TABLE_SUPERIOR_DROP,			"table_superior_drop_data");
	...
	flagManager.Set(CTableContainer::TABLE_DROP_NORBAG);
	fileNameList.SetFileName(CTableContainer::TABLE_DROP_NORBAG,				"Table_Drop_Bag_Data");
	flagManager.Set(CTableContainer::TABLE_DROP_GRPBAG); 
	fileNameList.SetFileName(CTableContainer::TABLE_DROP_GRPBAG,				"Table_Drop_Big_Bag");
	...
	flagManager.Set(CTableContainer::TABLE_CONTENTSONOFF);
	fileNameList.SetFileName(CTableContainer::TABLE_CONTENTSONOFF,				"table_contents_onoff_data");
...
//	fileNameList.SetFileName(CTableContainer::TABLE_DROP,					"table_drop_data");
	...
	flagManager.Set(CTableContainer::TABLE_SPECIAL_CHARACTER);
	fileNameList.SetFileName(CTableContainer::TABLE_SPECIAL_CHARACTER,		"Table_Special_Character_Data");
...
bool CTableContainerManager::LoadLocalizedTable()
{
	...
	flagManager.Set(CTableContainer::TABLE_NPC);
	fileNameList.SetFileName(CTableContainer::TABLE_NPC,					"o_Table_NPC_Data");
	flagManager.Set(CTableContainer::TABLE_ITEM);
	fileNameList.SetFileName(CTableContainer::TABLE_ITEM,					"o_Table_Item_Data");
	flagManager.Set(CTableContainer::TABLE_ITEM_OPTION);
	fileNameList.SetFileName(CTableContainer::TABLE_ITEM_OPTION,			"o_Table_Item_Option_Data");
	flagManager.Set(CTableContainer::TABLE_USE_ITEM);
	fileNameList.SetFileName(CTableContainer::TABLE_USE_ITEM,				"o_Table_Use_Item_Data");
	flagManager.Set(CTableContainer::TABLE_MERCHANT); 
	fileNameList.SetFileName(CTableContainer::TABLE_MERCHANT,				"o_Table_Merchant_Data");
	flagManager.Set(CTableContainer::TABLE_ITEM_RECIPE); 
	//fileNameList.SetFileName(CTableContainer::TABLE_ITEM_RECIPE,			"o_Table_Item_Recipe_Data");
	//flagManager.Set(CTableContainer::TABLE_ITEM_RECIPE);
	fileNameList.SetFileName(CTableContainer::TABLE_ITEM_RECIPE,			"table_item_recipe_new_data");
	flagManager.Set(CTableContainer::TABLE_QUEST_PROBABILITY);
	fileNameList.SetFileName(CTableContainer::TABLE_QUEST_PROBABILITY,		"o_table_quest_probability_data");
	flagManager.Set(CTableContainer::TABLE_TEXT_ALL);
	fileNameList.SetFileName(CTableContainer::TABLE_TEXT_ALL,				"o_table_text_all_data");
