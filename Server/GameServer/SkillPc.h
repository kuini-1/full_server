...
public:
	...
	virtual bool						UseSkill(BYTE byRpBonusType, HOBJECT hAppointTargetHandle, CNtlVector& rvFinalSubjectLoc, BYTE byApplyTargetCount, HOBJECT* ahApplyTarget, WORD & rwResultCode);
