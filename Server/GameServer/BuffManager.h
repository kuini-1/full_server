...
public:
	...
	virtual bool					RegisterBuff(DWORD& rdwKeepTime, eSYSTEM_EFFECT_CODE* effectCode, sDBO_BUFF_PARAMETER * paBuffParameter, HOBJECT hCaster, eBUFF_TYPE buffType, sSKILL_TBLDAT* pSkillTbldat);
	...
	void							RemoveAllRevivalAfterEffectBuff();
...
protected:
	...
	CNtlLinkArray_Static<CBuff *>	m_revivalAftereffectBuffList;
