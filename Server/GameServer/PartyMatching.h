...
public:
	...
	void				EnterReq(CPlayer* player);
	void				EnterRes(CPlayer* player);

	void				role(CPlayer* player, PARTYID partyId, BYTE byType, BYTE byRoleplay);

	BYTE				GetRole(BYTE byRoleplay);
};
