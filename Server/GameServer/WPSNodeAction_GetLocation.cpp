...
CWPSNodeAction_GetLocation::CWPSNodeAction_GetLocation(const char* lpszName)
:CControlScriptNodeAction(WPS_NODE_ACTION_GET_LOCATION, lpszName)
{
}

CWPSNodeAction_GetLocation::~CWPSNodeAction_GetLocation()
{

}

CWPSNodeAction_GetLocation::sPARAMETER_INFO* CWPSNodeAction_GetLocation::GetParameterMap()
{
	return NULL;
}


bool CWPSNodeAction_GetLocation::AddParam(CControlScriptNodeParam_Number* pNode)
{
	...
	printf("CWPSNodeAction_GetLocation: [%s] not exist \n", name);
	return false;
}

bool CWPSNodeAction_GetLocation::AddParam(CControlScriptNodeParam_String* pNode)
{
	const char* name = pNode->GetName();
...
bool CWPSNodeAction_GetLocation::CheckParameter()
{
