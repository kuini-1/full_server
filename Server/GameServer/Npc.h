...
public:
	...
	sNPC_TBLDAT*	GetTbldat() { return (sNPC_TBLDAT*)m_pTbldat; }
...
public:
	...
	float				GetAttackRange(CCharacter* pTarget);
	virtual float		GetAttackRange() { return CCharacter::GetAttackRange(); }
