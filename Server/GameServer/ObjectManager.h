...
public:
	...
	const boost::unordered_map<CHARACTERID, CPlayer*>&
										GetPlayerMap() const { return m_map_pkChrByPID; }
	const boost::unordered_map<HOBJECT, CGameObject*>&
										GetObjectMap() const { return m_map_CharByUID; }
