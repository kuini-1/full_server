		...
		{
			{
				...
				{
					if (item->byItemState == sPRIVATESHOP_ITEM_DATA::eITEMSTATE::PRIVATESHOP_BUSINESS_ITEM)
						resultcode = GAME_PRIVATESHOP_OWNER_BARGAINS;
					else if (item->byItemState == sPRIVATESHOP_ITEM_DATA::eITEMSTATE::PRIVATESHOP_VISITOR_SELECT_ITEM)
				...
				break;
				case sPRIVATESHOP_ITEM_DATA::eITEMSTATE::PRIVATESHOP_BUSINESS_ITEM:
				{
					resultcode = GAME_FAIL;
				}
				break;
