...
void CUG_Opcodes::BuildOpcodeList()
{
	...
	StoreOpcode(UG_PING, "UG_PING", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_ITEM_UPGRADE_REQ, "UG_ITEM_UPGRADE_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_SHOP_SKILL_BUY_REQ, "UG_SHOP_SKILL_BUY_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_SCOUTER_PREDICT_REQ, "UG_SCOUTER_PREDICT_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvScouterPredictReq);
	...
	StoreOpcode(UG_SCOUTER_CHIP_REMOVE_ALL_REQ, "UG_SCOUTER_CHIP_REMOVE_ALL_REQ", PROCESS_THREADUNSAFE, &CClientSession::OnInvalid);
	StoreOpcode(UG_SCOUTER_ACTIVATION_REQ, "UG_SCOUTER_ACTIVATION_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvScouterActivitationReq);
	StoreOpcode(UG_SOCIAL_ACTION, "UG_SOCIAL_ACTION", PROCESS_THREADUNSAFE, &CClientSession::RecvSocialSkill);
	...
	StoreOpcode(UG_PRIVATESHOP_ITEM_GET_REQ, "UG_PRIVATESHOP_ITEM_GET_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);	//NOT EXIST YET
	...
	StoreOpcode(UG_PRIVATESHOP_BUSINESS_REQUEST_REQ, "UG_PRIVATESHOP_BUSINESS_REQUEST_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);	//NOT EXIST YET
	StoreOpcode(UG_PRIVATESHOP_BUSINESS_CONSENT_RES, "UG_PRIVATESHOP_BUSINESS_CONSENT_RES", PROCESS_INPLACE, &CClientSession::OnInvalid);	//NOT EXIST YET
	StoreOpcode(UG_PRIVATESHOP_BUSINESS_WAITTIMEOUT_NFY, "UG_PRIVATESHOP_BUSINESS_WAITTIMEOUT_NFY", PROCESS_INPLACE, &CClientSession::OnInvalid);	//NOT EXIST YET
	StoreOpcode(UG_PRIVATESHOP_BUSINESS_PRICEFLUCTUATIONS_REQ, "UG_PRIVATESHOP_BUSINESS_PRICEFLUCTUATIONS_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);	//NOT EXIST YET
	StoreOpcode(UG_PRIVATESHOP_BUSINESS_IMMEDIATE_ITEM_BUYING_REQ, "UG_PRIVATESHOP_BUSINESS_IMMEDIATE_ITEM_BUYING_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);	//NOT EXIST YET
	StoreOpcode(UG_PRIVATESHOP_BUSINESS_CANCEL_REQ, "UG_PRIVATESHOP_BUSINESS_CANCEL_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);	//NOT EXIST YET
	StoreOpcode(UG_MAIL_START_REQ, "UG_MAIL_START_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvMailStartReq);
	...
	StoreOpcode(UG_MAIL_LOAD_REQ, "UG_MAIL_LOAD_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvMailLoadReq);
	...
	StoreOpcode(UG_WAR_FOG_UPDATE_REQ, "UG_WAR_FOG_UPDATE_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvWarFogUpdateReq);
	...
	StoreOpcode(UG_DICE_ROLL_REQ, "UG_DICE_ROLL_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvRollDiceReq);
	...
	StoreOpcode(UG_BUDOKAI_SOCIAL_ACTION, "UG_BUDOKAI_SOCIAL_ACTION", PROCESS_THREADUNSAFE, &CClientSession::RecvBudokaiSocialAction);
	...
	StoreOpcode(UG_SCOUTER_TURN_ON, "UG_SCOUTER_TURN_ON", PROCESS_INPLACE, &CClientSession::RecvScouterTurnOn);
	StoreOpcode(UG_SCOUTER_TURN_OFF, "UG_SCOUTER_TURN_OFF", PROCESS_INPLACE, &CClientSession::RecvScouterTurnOff);
	StoreOpcode(UG_SCOUTER_ITEM_SELL_REQ, "UG_SCOUTER_ITEM_SELL_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);	//NOT EXIST YET
	StoreOpcode(UG_SHOP_EVENTITEM_START_REQ, "UG_SHOP_EVENTITEM_START_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvEventItemShopReq);
	...
	StoreOpcode(UG_SHOP_EVENTITEM_END_REQ, "UG_SHOP_EVENTITEM_END_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvEndEventItemShopReq);
	...
	StoreOpcode(UG_VEHICLE_ENGINE_START_REQ, "UG_VEHICLE_ENGINE_START_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvVehicleStartEngineReq);
	StoreOpcode(UG_VEHICLE_ENGINE_STOP_REQ, "UG_VEHICLE_ENGINE_STOP_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvVehicleStopEngineReq);
	...
	StoreOpcode(UG_HOIPOIMIX_ITEM_CHECK_REQ, "UG_HOIPOIMIX_ITEM_CHECK_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_HOIPOIMIX_ITEM_MAKE_REQ, "UG_HOIPOIMIX_ITEM_MAKE_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_HOIPOIMIX_ITEM_MAKE_EP_REQ, "UG_HOIPOIMIX_ITEM_MAKE_EP_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_HOIPOIMIX_ITEM_MACHINE_DEL_REQ, "UG_HOIPOIMIX_ITEM_MACHINE_DEL_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_HOIPOIMIX_JOB_SET_REQ, "UG_HOIPOIMIX_JOB_SET_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_HOIPOIMIX_JOB_RESET_REQ, "UG_HOIPOIMIX_JOB_RESET_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_HOIPOIMIX_ITEM_CREATE_EX_REQ, "UG_HOIPOIMIX_ITEM_CREATE_EX_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvHoiPoiItemCreateExReq);
	StoreOpcode(UG_ITEM_DISASSEMBLE_REQ, "UG_ITEM_DISASSEMBLE_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvItemDisassembleReq);
	StoreOpcode(UG_CASHITEM_START_REQ, "UG_CASHITEM_START_REQ", PROCESS_INPLACE, &CClientSession::RecvCashItemStartReq);
	StoreOpcode(UG_CASHITEM_END_REQ, "UG_CASHITEM_END_REQ", PROCESS_INPLACE, &CClientSession::RecvCashItemEndReq);
	...
	StoreOpcode(UG_DOJO_BANK_HISTORY_REQ, "UG_DOJO_BANK_HISTORY_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_GAMEGUARD_AUTH_ANSWER_RES, "UG_GAMEGUARD_AUTH_ANSWER_RES", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_GAMEGUARD_HACK_INFO_NFY, "UG_GAMEGUARD_HACK_INFO_NFY", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_BUDOKAI_PRIZEWINNER_TEAM_NAME_REQ, "UG_BUDOKAI_PRIZEWINNER_TEAM_NAME_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_CASHITEM_UPDATE_DURATION_REQ, "UG_CASHITEM_UPDATE_DURATION_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_CHAR_DEST_MOVE_SYNC, "UG_CHAR_DEST_MOVE_SYNC", PROCESS_THREADUNSAFE, &CClientSession::RecvCharMoveSync);
	StoreOpcode(UG_CHAR_NPCSERVER_MOVE_SYNC, "UG_CHAR_NPCSERVER_MOVE_SYNC", PROCESS_THREADUNSAFE, &CClientSession::RecvCharNpcServerMoveSync);
	StoreOpcode(UG_HOIPOIMIX_ITEM_CREATE_REQ, "UG_HOIPOIMIX_ITEM_CREATE_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_MASCOT_SUMMON_REQ, "UG_MASCOT_SUMMON_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_MASCOT_UNSUMMON_REQ, "UG_MASCOT_UNSUMMON_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_MASCOT_DELETE_REQ, "UG_MASCOT_DELETE_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_CASHITEM_INFO_REQ, "UG_CASHITEM_INFO_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_ITEM_UPGRADE_WORK_REQ, "UG_ITEM_UPGRADE_WORK_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvItemUpgradeWorkReq);
	StoreOpcode(UG_ITEM_UPGRADE_PROBABLEITEM_REQ, "UG_ITEM_UPGRADE_PROBABLEITEM_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
	StoreOpcode(UG_REQUEST_CHAR_HISTORY_DATA_REQ, "UG_REQUEST_CHAR_HISTORY_DATA_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvCharHistoryDataReq);
	...
	StoreOpcode(UG_DROPITEM_INFO_REQ, "UG_DROPITEM_INFO_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvDropItemInfoReq);										//THREAD-UNSAFE: BECAUSE ITEM CAN BE DELETED BY THREAD MAIN THREAD WHILE SESSION THREAD TRY TO GET TE ITEM
	...
	StoreOpcode(UG_GAMEGUARD3_AUTH_ANSWER_RES, "UG_GAMEGUARD3_AUTH_ANSWER_RES", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_PERFORMANCE_DATA_NFY, "UG_PERFORMANCE_DATA_NFY", PROCESS_INPLACE, &CClientSession::RecvPerformanceDataNfy);
	StoreOpcode(UG_PERFORMANCE_DATA_2_NFY, "UG_PERFORMANCE_DATA_2_NFY", PROCESS_INPLACE, &CClientSession::OnInvalid);
	...
	StoreOpcode(UG_CHAR_AIR_POSE_REQ, "UG_CHAR_AIR_POSE_REQ", PROCESS_INPLACE, &CClientSession::OnInvalid);
