...
public:
	...
	void						RecvCharMoveSync(CNtlPacket * pPacket);
	void						RecvCharNpcServerMoveSync(CNtlPacket * pPacket);
	...
	//char history
	void						RecvCharHistoryDataReq(CNtlPacket * pPacket);


	void						RecvItemUpgradeWorkReq(CNtlPacket * pPacket);
	...
	void						RecvCashItemStartReq(CNtlPacket * pPacket);
	void						RecvCashItemEndReq(CNtlPacket * pPacket);
	...
	// SCOUTER
	void						RecvScouterTurnOn(CNtlPacket * pPacket);
	void						RecvScouterTurnOff(CNtlPacket * pPacket);
	void						RecvScouterIndicatorReq(CNtlPacket * pPacket);
	void						RecvScouterPredictReq(CNtlPacket * pPacket);
	void						RecvScouterActivitationReq(CNtlPacket * pPacket);
	...
	// SKILL
	void						SendShopSkillReq(CNtlPacket * pPacket);
	...
	//VEHICLE
	void						RecvVehicleStartEngineReq(CNtlPacket * pPacket);
	void						RecvVehicleStopEngineReq(CNtlPacket * pPacket);
	...
	//NEW RANDOM PACKETS
	void						RecvPerformanceDataNfy(CNtlPacket * pPacket);
	...
	//HOI POI
	void						RecvHoiPoiItemCreateExReq(CNtlPacket * pPacket);
