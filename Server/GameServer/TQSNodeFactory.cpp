...
CControlScriptNodeAction* CTQSNodeFactory::CreateControlNodeAction(const char* lpszNodeName)
{
	...
	std::unordered_map<std::string, CControlScriptNodeAction*(*)(const char*)>::iterator it = s_actionMap_tqs.find(lpszNodeName);
...
CControlScriptNodeCondition* CTQSNodeFactory::CreateControlNodeCondition(const char* lpszNodeName)
{
	...
	std::unordered_map<std::string, CControlScriptNodeCondition*(*)(const char*)>::iterator it = s_conditionMap_tqs.find(lpszNodeName);
