...
public:
	...
	virtual float	GetLastRunSpeed() { return NTL_DEFAULT_MOVEMENT_SPEED; }
	...
	inline void		SetMoveStatus(BYTE byMoveStatus) { this->m_byMoveStatus = byMoveStatus; }
	inline BYTE		GetMoveStatus() { return this->m_byMoveStatus; }
	...
	bool			CalculateJumpDir(CNtlVector* pvNewCurDir, CNtlVector* pvJumpHeading);
