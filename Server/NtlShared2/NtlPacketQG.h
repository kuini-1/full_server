...
BEGIN_PROTOCOL(QG_BUFF_LOAD_RES)
	...
	CHARACTERID				charId;
	BYTE					byCount;
	sBUFF_DATA				sBuff[NTL_MAX_BLESS_BUFF_CHARACTER_HAS + NTL_MAX_CURSE_BUFF_CHARACTER_HAS + NTL_MAX_SUB_BUFF_CHARACTER_HAS + NTL_MAX_REVIVAL_AFTEREFFECT_BUFF_CHARACTER_HAS];
END_PROTOCOL()
//------------------------------------------------------------------
...
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(QG_GIFT_SHOP_BUY_RES)
	HOBJECT					handle;
	WORD					wResultCode;
	CHARACTERID				charId;
	DWORD					dwGiftPoint;
...
BEGIN_PROTOCOL(QG_PC_DATA_LOAD_RES)
	...
	WORD						wWaguCoins;
	WORD						wEventCoins;
	sPC_NEW_DATA				sPcNewData;
	sACC_NEW_DATA				sAccNewData;
END_PROTOCOL()
//------------------------------------------------------------------
