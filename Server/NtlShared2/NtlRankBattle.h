...
enum eRANKBATTLE_BATTLESTATE
{
	...
	RANKBATTLE_BATTLESTATE_STAGE_READY,		// Preparation Stage
	RANKBATTLE_BATTLESTATE_STAGE_RUN,		// Ready
	RANKBATTLE_BATTLESTATE_STAGE_FINISH,	// Progress fight
	RANKBATTLE_BATTLESTATE_MATCH_FINISH,	// Played
