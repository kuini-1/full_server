...
#define NTL_MAX_WEB_ONLINE_PLAYERS						(90)
#define NTL_MAX_WEB_SERVER_LIST						(48)
#define NTL_MAX_WEB_FARM_LIST							(16)
#define NTL_MAX_WEB_CHANNEL_LIST						(40)
#define NTL_MAX_WEB_CHANNEL_COUNT_LIST					(40)
#define NTL_MAX_WEB_FARM_COUNT_LIST						(16)
#define NTL_MAX_WEB_ACCOUNT_LIST						(200)
#define NTL_MAX_WEB_CHANNEL_FLAG_LIST					(40)
...
#define NTL_MAX_COUNT_USER_HAVE_INVEN_ITEM				(161)
...
#define NTL_MAX_SIZE_GUILD_NAME_IN_UNICODE				(16)
