...
bool Dbo_IsValidStateToUseSkill(DWORD dwTransformUseInfoBitFlag, BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, bool bIsSwimmingState, bool bIsJumpingState, eAIR_STATE eAirState, WORD *pwResultCode)
{
	...
	if (pwResultCode)
		*pwResultCode = 603; // GAME_SKILL_CANT_CAST_NOW;
	...
	else
	{
		...
		if (bAnyRestrictedState || BIT_FLAG_TEST(dwTransformUseInfoBitFlag, SKILL_TRANSFORM_USE_INFO_FLAG_ABLE_WHEN_NORMAL))
		{
			...
			else
			{
				...
				{
					if (pwResultCode)
						*pwResultCode = 668; // GAME_ANOTHER_SKILL_CANT_CAST_NOW;
				}
			}
		}
	}
...
bool Dbo_IsState_GreatNamek(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
...
bool Dbo_IsState_SuperSaiyan(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
	UNREFERENCED_PARAMETER(eStunType);
	UNREFERENCED_PARAMETER(byCurStateId);
	UNREFERENCED_PARAMETER(qwCurCharCondition);
...
bool Dbo_IsState_PureMajin(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
	UNREFERENCED_PARAMETER(eStunType);
	UNREFERENCED_PARAMETER(byCurStateId);
	UNREFERENCED_PARAMETER(qwCurCharCondition);
...
bool Dbo_IsState_Kaioken(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
	UNREFERENCED_PARAMETER(eStunType);
	UNREFERENCED_PARAMETER(byCurStateId);
	UNREFERENCED_PARAMETER(qwCurCharCondition);
...
bool Dbo_IsState_SpinningAttack(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
	UNREFERENCED_PARAMETER(eStunType);
	UNREFERENCED_PARAMETER(byCurStateId);
	UNREFERENCED_PARAMETER(qwCurCharCondition);
...
bool Dbo_IsState_Vehicle(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
	UNREFERENCED_PARAMETER(eStunType);
	UNREFERENCED_PARAMETER(byCurStateId);
	UNREFERENCED_PARAMETER(qwCurCharCondition);
...
bool Dbo_IsState_MindCurse(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
	UNREFERENCED_PARAMETER(byCurStateId);
	UNREFERENCED_PARAMETER(eStunType);
...
bool Dbo_IsState_BodyCurse(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
	UNREFERENCED_PARAMETER(byCurAspectStateId);
	UNREFERENCED_PARAMETER(validAspectState);
...
bool Dbo_IsState_ChangeCurse(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
	UNREFERENCED_PARAMETER(byCurAspectStateId);
	UNREFERENCED_PARAMETER(qwCurCharCondition);
	UNREFERENCED_PARAMETER(validAspectState);
...
bool Dbo_IsState_RollingAttack(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
	UNREFERENCED_PARAMETER(byCurStateId);
	UNREFERENCED_PARAMETER(eStunType);
	UNREFERENCED_PARAMETER(qwCurCharCondition);
...
bool Dbo_IsState_Rabies(BYTE byCurStateId, eDBO_STUN_TYPE eStunType, BYTE byCurAspectStateId, QWORD qwCurCharCondition, CNtlBitFlagManager *validState, CNtlBitFlagManager *validAspectState, QWORD *qwValidCharCondition)
{
	UNREFERENCED_PARAMETER(byCurStateId);
	UNREFERENCED_PARAMETER(eStunType);
	UNREFERENCED_PARAMETER(byCurAspectStateId);
