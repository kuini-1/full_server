...
public:
	...
	WCHAR			wszName[NTL_MAX_SIZE_GUILD_NAME_IN_UNICODE + 1];	// Guild Name
	...
	WCHAR			wchNotice[NTL_MAX_LENGTH_OF_DOJO_NOTICE_UNICODE + 1];	//'' Notice	
};
...
struct sDBO_DOJO_NPC_INFO
{
	...
	WCHAR				wszChallengeName[NTL_MAX_SIZE_GUILD_NAME_IN_UNICODE + 1]; //challenger guild name
