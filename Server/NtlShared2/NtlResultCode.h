...
enum eRESULTCODE
{
	...
	AUTH_SNCH_NEED_REAL_NAME_CHECK,
	AUTH_SUCCESS_SNCH_NEED_REAL_NAME_CHECK,
	AUTH_NEED_SNCH_NEED_REAL_NAME_CHECK_1000,
	AUTH_NEED_SNCH_NEED_REAL_NAME_CHECK_2000,
	AUTH_FAIL_SNCH_NEED_REAL_NAME_CHECK_3000,
	AUTH_SUCCESS_SNCH_NEED_REAL_NAME_CHECK_5000,
	AUTH_FAIL_SNCH_NEED_REAL_NAME_CHECK_6000,
	...
	// warning! current enum number is 899. -> 아이템 관련은 3000번대에서 새로 추가.
	...
	//new
	GAME_GM_TOOL_INVALID_GM_TOOL_LOCALIZE_TYPE,
	...
	//-----------------------------------------------------------------
	GAME_TS_WARNING_END = 1535,							// Trigger warning message 종료
