...
enum eITEM_TYPE
{
	...
	ITEM_TYPE_UTILITY,
	ITEM_TYPE_CHARM,
	ITEM_TYPE_CAPSULE,			// VEHICLE Å»°ÍÀÌ³ª È£ÀÌÆ÷ÀÌ¸Ó½Å Ä¸½¶ÇÏ¿ì½ºµî ´øÀú¼­ »ý¼ºµÇ´Â Ä¸½¶ÇüÅÂ·ÎµÈ ¾ÆÀÌÅÛ
	ITEM_TYPE_FUEL,
	ITEM_TYPE_JUNK,
...
enum eCONTAINER_TYPE
{
	...
	CONTAINER_TYPE_SCOUT,				// Place °¡ 7ÀÎ °¡¹æ°ú °°Àº ¿ªÇÒ Scouter Parts °¡ µé¾î °¥°÷
...
enum eITEM_FUNC_BIT_FLAG // wFuncionBitFlag in sITEM_TBLDAT
{
	...
	ITEM_FUNC_BIT_FLAG_DELETE_FORBIDDEN = 0x01 << ITEM_FUNC_TYPE_DELETE_FORBIDDEN,
...
//-----------------------------------------------------------------------------------
// Items scouts parts feature type definitions
//-----------------------------------------------------------------------------------
enum eSCOUTER_PARTS_TYPE
{
	...
	SCOUTER_PARTS_DODGE_RATE,
	SCOUTER_PARTS_BLOCK_RATE,
	SCOUTER_PARTS_CURSE_SUCCESS_RATE,
	SCOUTER_PARTS_CURSE_TOLERANCE_RATE,
	SCOUTER_PARTS_ITEM_UPGRADE_RATE_UP,
	SCOUTER_PARTS_ITEM_BREAK_RATE_DOWN,
	SCOUTER_PARTS_MATERIAL_DECOMPOSITION,
	SCOUTER_PARTS_LUMINOSITY,
	SCOUTER_PARTS_QUEST_SUPPORT,
	SCOUTER_PARTS_REMOTE_SHOP,
	SCOUTER_PARTS_REMOTE_SHOP_BUY,
	SCOUTER_PARTS_REMOTE_SHOP_SELL,
	SCOUTER_PARTS_REMOTE_TMP,
	SCOUTER_PARTS_REMOTE_BANK,
	
	SCOUTER_PARTS_COUNT,

	SCOUTER_PARTS_INVALID = 0xFF,

	SCOUTER_PARTS_FIRST = SCOUTER_PARTS_NONE ,
	SCOUTER_PARTS_LAST = SCOUTER_PARTS_COUNT - 1,
};
//-----------------------------------------------------------------------------------
// ¿É¼Ç Å×ÀÌºíÀÇ ½ºÄ«¿ìÅÍ ÀÎÆ÷ÀÇ ¹Ì´ÏÅ×ÀÌºí
//-----------------------------------------------------------------------------------
enum eSCOUTER_INFO
{
	...
	SCOUTER_INFO_UPGRADE_RATE_UP,			///< ¾ÆÀÌÅÛ È®·ü %d ¹è
	SCOUTER_INFO_ITEM_BREAK_RATE_DOWN,		///< ¾ÆÀÌÅÛ ÆÄ±« È®·ü -%d

	SCOUTER_INFO_LP_RECOVERY,
	SCOUTER_INFO_EP_RECOVERY,
	SCOUTER_INFO_CRAFTS_DAMAGE_REFLEX_RATE,
	SCOUTER_INFO_RP_RECOVERY,
	SCOUTER_INFO_CRITICAL_IMPEDE,
	SCOUTER_INFO_QUICKMASTERY_REFLEX,
	SCOUTER_INFO_BLOW_DAMAGE_REFLEX,
	SCOUTER_INFO_CRAFTS_DAMAGE_REFLEX,
	SCOUTER_INFO_LP_RECOVERY_RATE,
	SCOUTER_INFO_EP_RECOVERY_RATE,
	SCOUTER_INFO_RP_RECOVERY_RATE,
	SCOUTER_INFO_BLOW_DAMAGE_REFLEX_RATE,
	SCOUTER_INFO_QUEST_MASTER,

	SCOUTER_INFO_COUNT,
	
	SCOUTER_INFO_FIRST = SCOUTER_INFO_LP,
	SCOUTER_INFO_LAST = SCOUTER_INFO_COUNT - 1,
	
	SCOUTER_INFO_BEGIN_ONLY_ALLPY_MAX   = 40,	///< ÀÌÈÄ´Â °¡Àå ÁÁÀº ±â´ÉÀÇ ÆÄÃ÷ ÇÏ³ª¸¸ Ç¥½ÃµÈ´Ù

	SCOUTER_INFO_BEGIN_SPECIAL_FUNCTION = 100,	///< ÀÌÈÄ´Â Å×ÀÌºí¿¡ ¼³¸íµÈ ±×´ë·Î º¸¿©ÁØ´Ù
	SCOUTER_INFO_RESERVATED = SCOUTER_INFO_BEGIN_SPECIAL_FUNCTION,
	SCOUTER_INFO_PC_INFO_JAMMING,									///< ¿³º¸±â ¹æÇØ
	SCOUTER_INFO_OBJECT_FINDER,										///< ¼ûÀº ¹°°Ç Ã£±â
	SCOUTER_INFO_CONNECTOR,											///< ¿ìÆíÇÔ Á¢¼Ó
	SCOUTER_INFO_TRANSMITTER,										///< ¹°Áú Àü¼Û
	SCOUTER_INFO_DRAGON_BALL_SEARCH,								///< µå·¡°ïº¼ ¼ÒÁö ¸ó½ºÅÍ Ç¥½Ã
	SCOUTER_INFO_ITEM_IDENTIFICATION,								///< ¾ÆÀÌÅÛ °¨Á¤
	SCOUTER_INFO_PC_INFO_VIEWER,									///< ¼öÇàÀÚ ¿³º¸±â
	SCOUTER_INFO_QUEST_SEARCH,										///< ÁÖº¯Äù½ºÆ® °Ë»ö
	SCOUTER_INFO_MATERIAL_DECOMPOSITION,
	SCOUTER_INFO_LUMINOSITY,
	SCOUTER_INFO_REMOTE_SHOP,
	SCOUTER_INFO_REMOTE_SHOP_BUY,
	SCOUTER_INFO_REMOTE_SHOP_SELL,
	SCOUTER_INFO_REMOTE_TMP,
	SCOUTER_INFO_REMOTE_BANK,
...
{
	bool			bNormalStart;	// Register the normal quest rewards, or whether to buy
	
	bool			bSpecialStart;	// Specialty mix whether registration
...
struct sITEM_MIX_MAIN_DATA//deleted in new version
{
...
struct sITEM_DATA
{
	...
	DWORD			dwUnknown; //find out what it is. If this DWORD does not exist then there are problems with private shop and trade. Maybe other places too.
};
...
struct sTRADE_INVEN
{
	...
	TBLIDX	itemTblidx; // used for logging
};
...
enum ePRIVATESHOP_STATE
{
	...
	,PRIVATESHOP_STATE_BUSINESS_WAIT		//ÈïÁ¤ ´ë±â
	,PRIVATESHOP_STATE_BUSINESS				//ÈïÁ¤Áß
...
struct sPRIVATESHOP_ITEM_DATA
{
	enum eITEMSTATE
	{
		...
		PRIVATESHOP_BUSINESS_ITEM			= 1, // Being bargained item (jjimhan items can not be bargained)
		PRIVATESHOP_VISITOR_SELECT_ITEM		= 2, // Steamed item
		PRIVATESHOP_VISITOR_UNSELECT_ITEM	= 3, // Unpacking steamed items
...
// ShopSystem »ç¿ë ÇÏ´Â ¾ÆÀÌÅÛ ÆÈ±â Sell_Price, dwCost, dwOptionCost -> S C O

#define NTL_SELL_PRICE(S, C, O)	  ( ( ( ( (float)(S) / 100.0 ) * (float)C) + O) )
//S = bySell_Price, C = dwCost, A = byStack
#define SELL_ITEM_TO_NPC_PRICE(S,C,A) ( ( (S / 100.0f) * C ) * A  )
#define SELL_ITEM_TO_SCOUTER_PRICE(S,C,A) ( ( ( (S / 100.0f) * C ) * A  ) / 2 )
...
// Item Brief
bool Dbo_SetItemBrief( sITEM_BRIEF* const pItemBrief, TBLIDX tblidx, BYTE byRank, BYTE byGrade, BYTE byBattleAttribute );
// Item Shop
