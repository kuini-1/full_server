...
const char * s_packetName_CU[] =
{
	...
	//new
	DECLARE_PACKET_NAME( CU_CASHITEM_HLSHOP_REFRESH_RES ),
	DECLARE_PACKET_NAME( CU_CASHITEM_BUY_RES ),
	DECLARE_PACKET_NAME( CU_PREMIUM_SLOT_COUNT_NFY ),
	DECLARE_PACKET_NAME( CU_CHAR_SERVERLIST_RES ),
	DECLARE_PACKET_NAME( CU_SERVER_FARM_INFO_NFY ),
