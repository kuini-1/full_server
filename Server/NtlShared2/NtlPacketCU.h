...
//------------------------------------------------------------------
//new
BEGIN_PROTOCOL( CU_CASHITEM_HLSHOP_REFRESH_RES )
	WORD			wResultCode;
	DWORD			dwRemainAmount;
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL( CU_CASHITEM_BUY_RES )
	WORD			wResultCode;
	DWORD			dwRemainAmount;
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL( CU_PREMIUM_SLOT_COUNT_NFY )
	BYTE			byPremiumSlotCount;
END_PROTOCOL()
//------------------------------------------------------------------
...
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL( CU_SERVER_FARM_INFO_NFY )
	sDBO_GAME_SERVER_FARM_INFO		serverFarmInfo;
END_PROTOCOL()
//------------------------------------------------------------------
#pragma pack()