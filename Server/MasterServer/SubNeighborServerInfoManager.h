...
public:
	...
	size_t						GetGameServerSessionCount() const { return m_mapGameServerSession.size(); }
	size_t						GetAuthServerSessionCount() const { return m_mapAuthServerSession.size(); }
	size_t						GetCharServerSessionCount() const { return m_mapCharacterServerSession.size(); }
	size_t						GetChatServerSessionCount() const { return m_mapChatServerSession.size(); }
...
public:
	...
	const std::unordered_map<ACCOUNTID, _SERVER_PAIR_ID>&
								GetGameServerPlayerMap() const { return m_map_GameServerPlayers; }
